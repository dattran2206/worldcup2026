 ...
 * Sử dụng 'mongoose' (đã có sẵn trong dự án) để đảm bảo không bị crash do thiếu thư viện.
 */
...
// Đọc cả 2 biến môi trường MONGODB_URL và MONGO_URI
...
const TEAM_MAP = {
  ...
  "năm phi": "South Africa",
  "nnam phi": "South Africa",
  "nphi": "South Africa",
  "nông phi": "South Africa",
  "năm phi": "South Africa",
  "nam phi": "South Africa",
  "nước cộng hòa nam phi": "South Africa",
  "nước cộng hòa nam phi": "South Africa",
...
async function main() {
  try {
    ...
    // Lấy đối tượng kết nối driver thuần từ Mongoose để thực hiện truy vấn trực tiếp
